  ...
  <div class="container flex-col items-center relative w-screen h-screen">
    ...
    <div class="w-screen h-screen relative ">
      <div class="overflow-hidden">
        <div class="relative">
          <img :src="state.initData.bg" class="w-full h-screen" />
        </div>
      </div>
      ...
      <div class="absolute top-50vh left-15vw text-white w-50vw transform -translate-y-1/2">
        ...
        <div class="content my-7 text-7 w-full">{{ state.initData.head.hitokoto }}</div>
        <div class="my-7 text-5">——{{ state.initData.head.ty }}:{{ state.initData.head.from }}</div>
      </div>
    </div>
        ...
        <div class="flex flex-col items-center w-full ">
          <div
            ...
            <div class="imgbox md:w-3/5 ">
              <img :src="item.imgs" class="w-full  max-h-100 rounded-2 hover:opacity-75 cursor-pointer"
